...
public class SofaCasaSograSetup : MonoBehaviour
{
    // idMovel do Sofa da Sogra
    const int ExpectedMovelId = 5;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<object, bool>(itemsObj =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[4] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[4] = true;
