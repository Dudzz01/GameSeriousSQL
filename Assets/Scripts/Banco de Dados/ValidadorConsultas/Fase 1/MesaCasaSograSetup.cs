...
public class MesaCasaSograSetup : MonoBehaviour
{
    // idMovel do Espelho da Sogra
    const int ExpectedMovelId = 11;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<object, bool>(itemsObj =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[10] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[10] = true;
