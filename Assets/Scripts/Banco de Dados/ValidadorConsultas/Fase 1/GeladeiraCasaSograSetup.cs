...
public class GeladeiraCasaSograSetup : MonoBehaviour
{
    // idMovel do Espelho da Sogra
    const int ExpectedMovelId = 9;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<object, bool>(itemsObj =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[8] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[8] = true;
