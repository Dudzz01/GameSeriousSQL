...
public class CamaQuartoAbandonado : MonoBehaviour
{

    const int ExpectedMovelId = 62;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[32] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[32] = true;
