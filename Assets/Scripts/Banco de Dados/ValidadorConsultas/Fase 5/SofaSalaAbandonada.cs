...
public class SofaSalaAbandonada : MonoBehaviour
{

    const int ExpectedMovelId = 55;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[31] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[31] = true;
