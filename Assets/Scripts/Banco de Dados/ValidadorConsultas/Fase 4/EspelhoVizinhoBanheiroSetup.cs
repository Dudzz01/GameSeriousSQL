...
public class EspelhoVizinhoBanheiroSetup : MonoBehaviour
{
    const int ExpectedComodoId = 13;
    const int ExpectedMovelId = 50;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (nomeItemVal != null && nomeItemVal != "ChaveVasoVizinho")
                return DebugFail($"NomeItem='{nomeItemVal}' (esperado 'ChaveVasoVizinho' ou null)");
