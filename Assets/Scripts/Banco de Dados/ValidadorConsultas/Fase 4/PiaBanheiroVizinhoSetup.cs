...
public class PiaBanheiroVizinhoSetup : MonoBehaviour
{
    const int ExpectedComodoId = 13;
    const int ExpectedMovelId = 51;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (nomeItemVal != null && nomeItemVal != "ChavePiaBanhoVizinho")
                return DebugFail($"NomeItem='{nomeItemVal}' (esperado 'ChavePiaBanhoVizinho' ou null)");
