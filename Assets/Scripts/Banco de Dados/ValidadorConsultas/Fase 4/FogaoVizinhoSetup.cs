...
public class FogaoVizinhoSetup : MonoBehaviour
{
    const int ExpectedComodoId = 12;
    const int ExpectedMovelId = 45;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[28] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[28] = true;
