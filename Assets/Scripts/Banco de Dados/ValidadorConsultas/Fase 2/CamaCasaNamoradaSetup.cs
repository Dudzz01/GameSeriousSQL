...
public class CamaCasaNamoradaSetup : MonoBehaviour
{
    
    const int ExpectedMovelId = 25;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<object, bool>(itemsObj =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[12] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[12] = true;
