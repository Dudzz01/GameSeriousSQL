...
public class MesaSalaAvo : MonoBehaviour
{

    const int ExpectedMovelId = 68;  // o IdMovel do desafio
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[33] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[33] = true;
