...
public class MesaCozinhaAvo : MonoBehaviour
{

    const int ExpectedMovelId = 72;  // o IdMovel do desafio
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[34] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[34] = true;
