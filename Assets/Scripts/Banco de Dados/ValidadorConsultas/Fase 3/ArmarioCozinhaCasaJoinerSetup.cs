...
public class ArmarioCozinhaJoinerSetup : MonoBehaviour
{
    const int ExpectedMovelId = 29;
    ...
    void Awake()
    {
        ...
        fi.validator = new Func<string, object, bool>((sql, itemsObj) =>
        {
            ...
            string[] expectedItems = { "ChaveCozinhaJoiner", "EsponjaJoiner" };
            ...
            if (GameController.s.quantidadesDesafiosConcluidos[9] == false)
            {
                GameController.s.quantidadesDesafiosConcluidos[9] = true;
